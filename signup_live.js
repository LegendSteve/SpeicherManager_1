...
function getZahl(){
    ...
    popup.originales_fenster = this.window;   

    popup.zahl = popup.$('tr').find('td:contains("Verwenden Sie zum Bestätigen Ihrer E-Mail-Adresse den folgenden Sicherheitscode: ")').children()[0].innerHTML; 
    originales_fenster.postMessage("Zahl: "+popup.zahl), "https://10minutemail.com";
    popup.close();
}
